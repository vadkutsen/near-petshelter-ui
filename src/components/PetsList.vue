<template>
    <div v-if="pets.length > 0" class="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-3 lg:gap-8 lg:items-center lg:items-stretch">
      <div v-for="item in pets" :key="item[0]">
